...
$GLOBALS['TL_DCA']['tl_metamodel_rendersettings']['fields']['sitemap'] = array
(
    'label'         => &$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['sitemap'],
    'exclude'       => true,
    'inputType'     => 'checkbox',
...
array_push($GLOBALS['TL_DCA']['tl_metamodel_rendersettings']['metapalettes']['default']['expert'], 'sitemap');
